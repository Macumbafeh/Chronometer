...
function Chronometer:WarlockSetup()
	...
	self:AddTimer(self.SPELL, BS["Fear"],                   10, 1,0,0, { gr=3, rc=true, d={rs=5}, dr=1 })
	self:AddTimer(self.SPELL, BS["Fel Domination"],         15, 0,1,1)
	self:AddTimer(self.SPELL, BS["Howl of Terror"],         10, 0,0,0, { d={rs=5}, dr=1 })
	...
	self:AddTimer(self.SPELL, BS["Unstable Affliction"],    18, 1,0,0, { rc=true })
	self:AddTimer(self.SPELL, BS["Shadowfury"],              2, 1,0,0)
	...
	self:AddTimer(self.EVENT, BS["Seduction"],              15, 1,0,1, { cr="RED", dr=1 })
	...
	self:AddTimer(self.EVENT, BS["Nether Protection"],       4, 0,1,1, { cr="GREEN", a=1, xn=BS["Nether Protection"] })
