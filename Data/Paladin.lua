...
--	self:AddTimer(self.SPELL, BS["Blessing of Kings"],     300, 1,1,1, { gr=1 })
--	self:AddTimer(self.SPELL, BS["Blessing of Light"],     300, 1,1,1, { gr=1 })
--	self:AddTimer(self.SPELL, BS["Blessing of Might"],     300, 1,1,1, { gr=1 })
	self:AddTimer(self.SPELL, BS["Blessing of Protection"],  6, 1,1,1, { gr=1, d={rs=2}, ea={[BS["Forbearance"]]=1} })
	self:AddTimer(self.SPELL, BS["Blessing of Sacrifice"],  30, 1,1,1, { gr=1 })
--	self:AddTimer(self.SPELL, BS["Blessing of Salvation"], 300, 1,1,1, { gr=1 })
--	self:AddTimer(self.SPELL, BS["Blessing of Sanctuary"], 300, 1,1,1, { gr=1 })
--	self:AddTimer(self.SPELL, BS["Blessing of Wisdom"],    300, 1,1,1, { gr=1 })
	...
	self:AddTimer(self.SPELL, BS["Hammer of Justice"],       6, 1,0,0, { dr=1 })
...
--  self:AddTimer(self.SPELL, BS["Lay on Hands"],            0, 1,1,1, { ea={[BS["Lay on Hands"]]=2} })
	...
	self:AddTimer(self.SPELL, BS["Seal of Command"],        30, 0,1,1, { gr=2 })
	self:AddTimer(self.SPELL, BS["Seal of Justice"],        30, 0,1,1, { gr=2, dr=2 })
	self:AddTimer(self.SPELL, BS["Seal of Light"],          30, 0,1,1, { gr=2 })
	self:AddTimer(self.SPELL, BS["Seal of Righteousness"],  30, 0,1,1, { gr=2 })
	self:AddTimer(self.SPELL, BS["Seal of the Crusader"],   30, 0,1,1, { gr=2 })
	self:AddTimer(self.SPELL, BS["Seal of Wisdom"],         30, 0,1,1, { gr=2 })
	self:AddTimer(self.SPELL, BS["Turn Undead"],            10, 1,0,0, { gr=3, d={rs=5} })
	self:AddTimer(self.SPELL, BS["Divine Illumination"],    15, 0,1,1)
	self:AddTimer(self.SPELL, BS["Avenger's Shield"],        6, 1,0,0)

	self:AddTimer(self.EVENT, BS["Forbearance"],               60, 1,0,1, { tx="Interface\\Icons\\Spell_Holy_RemoveCurse" })
	self:AddTimer(self.EVENT, BS["Judgement of Justice"],      20, 1,0,0, { cr="RED", xn=BS["Seal of Justice"], rom=true })
	self:AddTimer(self.EVENT, BS["Judgement of Light"],        20, 1,0,0, { cr="RED", xn=BS["Seal of Light"], rom=true })
	self:AddTimer(self.EVENT, BS["Judgement of Wisdom"],       20, 1,0,0, { cr="RED", xn=BS["Seal of Wisdom"], rom=true })
	self:AddTimer(self.EVENT, BS["Judgement of the Crusader"], 20, 1,0,0, { cr="RED", xn=BS["Seal of the Crusader"], rom=true })
